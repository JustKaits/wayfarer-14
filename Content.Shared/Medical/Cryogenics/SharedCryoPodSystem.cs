...
public abstract partial class SharedCryoPodSystem : EntitySystem
{
    ...
    private static readonly string[] CryogenicsReagents = ["Cryoxadone", "Aloxadone", "Doxarubixadone", "Opporozidone", "Necrosol", "Traumoxadone", "Stelloxadone", "Ruboxadone",]; // Warfarer: Added Ruboxadone to the list of cryogenics.
